...
public class DNSGKZBLogPo {
	...
	public String toString() {
		return "DNSGKZBLogPo [bhsj=" + bhsj + ", pzid=" + pzid + ", flid=" + flid + ", xzid=" + xzid + ", lhid=" + lhid
				+ ", ydy=" + ydy + ", mddy=" + mddy + ", pzlx=" + pzlx + ", gklb=" + gklb + ", qdjip=" + qdjip
				+ ", sip=" + sip + ", dip=" + dip + ", sport=" + sport + ", dport=" + dport + ", protocol=" + protocol
				+ ", protoId=" + protoId + ", detailId=" + detailId + ", dnsName=" + dnsName + ", dnsValue=" + dnsValue
				+ ", yys=" + yys + ", yl1=" + yl1 + ", yl2=" + yl2 + ", yl3=" + yl3 + ", yl4=" + yl4 + ", yl5=" + yl5
				+ ", label=" + label + "]";
	}
