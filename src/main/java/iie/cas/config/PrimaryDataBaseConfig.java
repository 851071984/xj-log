...
public class PrimaryDataBaseConfig {
	 ...
	 * dao层的包路径
	 */
	static final String PACKAGE = "iie.cas.dao.primary";
	...
	public SqlSessionFactory primarySqlSessionFactory(@Qualifier("primaryDataSource") DataSource primaryDataSource)
		...
		sessionFactory.setMapperLocations(
				new PathMatchingResourcePatternResolver().getResources(PrimaryDataBaseConfig.MAPPER_LOCATION)); // 设置mapper文件路径
